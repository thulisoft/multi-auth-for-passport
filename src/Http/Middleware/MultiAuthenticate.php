...
namespace Thulisoft\MultiAuthForPassport\Http\Middleware;
...
use Thulisoft\MultiAuthForPassport\Guards\GuardChecker;
use Thulisoft\MultiAuthForPassport\PassportMultiauth;
use Thulisoft\MultiAuthForPassport\Provider as Token;
...
class MultiAuthenticate extends Authenticate
{
     ...
     * @throws \Thulisoft\MultiAuthForPassport\Exceptions\MissingConfigException
     */
